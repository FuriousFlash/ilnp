...
#ifdef WITH_ILNP
        uint maxCNBindingLifetime;
        simtime_t maxLUAckTimeout;
        simtime_t initialLUAckTimeout;
#endif
    };
...
#ifdef WITH_ILNP
    uint _getMaxCNBindingLifetime() const {return hostConstants.maxCNBindingLifetime;}
    simtime_t _getInitialLUAckTimeout() const {return hostConstants.initialLUAckTimeout;}
    simtime_t _getMaxLUAckTimeout() const {return hostConstants.maxLUAckTimeout;}
#endif

#ifdef WITH_ILNP
    virtual void _setMaxCNBindingLifetime(uint d) {hostConstants.maxCNBindingLifetime = d;}
    virtual void _setInitialLUAckTimeout(simtime_t d) {hostConstants.initialLUAckTimeout = d;}
    virtual void _setMaxLUAckTimeout(simtime_t d) {hostConstants.maxLUAckTimeout = d;}
#endif
