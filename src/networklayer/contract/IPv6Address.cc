...
// @kbteja..
// create new masks for ILNP Identifier.
const uint32 LINK_LOCAL_MASK = 0xFFC00000;
const uint32 SITE_LOCAL_MASK = 0xFFC00000;
const uint32 MULTICAST_MASK = 0xFF000000;
const uint32 ILNP_IDENTIFIER_MASK_1 = 0x000000FF;
const uint32 ILNP_IDENTIFIER_MASK_2 = 0xFF000000;
...
// @kbteja..
// adding the scope for new address type ILNP.
IPv6Address::Scope IPv6Address::getScope() const
{
    ...
    if ((d[0]&ILNP_IDENTIFIER_MASK_1) == 0x000000FF && 
        (d[1]&ILNP_IDENTIFIER_MASK_2) == 0xFE000000)
    {
        return ILNP;
    }
    else if ((d[0] & LINK_LOCAL_MASK) == LINK_LOCAL_PREFIX )
    {
        return LINK;
    }
